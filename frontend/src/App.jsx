...
const App = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      alert("Bad Request Detected. Please try again!")
    ...
    <div className="flex flex-col h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <header className="p-4 flex justify-between items-center border-b border-blue-500/30">
        ...
        <div className="flex gap-3 justify-center items-center">
          <a target="_blank" href="https://github.com/githubxnishant/docGPT.git" className="bg-gray-800/50 px-3 md:flex justify-center items-center gap-2 py-2 cursor-pointer rounded-lg font-medium text-sm transition-all hover:bg-gray-600 border border-gray-600 hidden">
            <svg width="20" height="20" className="text-text-secondary hover:text-text-primary cursor-pointer transition-all duration-300 hover:fill-[#E2E8F0]" fill="#94A3B8" viewBox="0 0 24 24">
